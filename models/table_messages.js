...
exports.getMessages = async function(conn,ROOMID){
    try{
        let getData = await conn.query(
            " SELECT ROOMID,CONTENT,TYPE,FILE,INS_USER,INS_DATE,INS_DATE_TIME,FILE_TYPE,FILE_NAME FROM ( " +
            "   SELECT a.ROOMID,a.CONTENT,a.TYPE,a.FILE,a.INS_USER,a.INS_DATE INS_DATE_TIME,DATE_FORMAT(a.INS_DATE, '%Y-%m-%d') INS_DATE,b.TYPE as FILE_TYPE,b.FILE_NAME " +
